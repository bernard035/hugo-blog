...
1. 将算法用三种主流程序设计语言（C++,Java,Python）表示出来- 对于每个算法，利用Manim制作一分钟左右的讲解视频，重点讲原理
...
1. 以git上的表述为准- 代码格式化采用Google样式：{BasedOnStyle: Google, IndentWidth: 4} 和devc++里的“Java”方案很像

![图片说明](/images/9d721a51c44af6f3.png)
...
> 本文整理自作者牛客博客（https://blog.nowcoder.net/n/665426960ce84cc487aeff25f6a44c53），发布于 2020-07-11。
